...
impl StorageProvider for OneDriveProvider {
    async fn fetch(
        ...
        Err(FetchError {
            message: "OneDrive provider not implemented".into(),
        })
    }
    ...
    async fn size_and_mtime(
        ...
        Err(FetchError {
            message: "OneDrive size_and_mtime not implemented".into(),
        })
    }
    ...
    async fn save(
        ...
        Err(FetchError {
            message: "OneDrive save not implemented".into(),
        })
    }
}
...
mod tests {
    ...
    async fn test_onedrive_provider_fetch() {
        ...
        assert!(result
            .unwrap_err()
            .message
            .contains("OneDrive provider not implemented"));
    }
    ...
    async fn test_onedrive_provider_size_and_mtime() {
        ...
        assert!(result
            .unwrap_err()
            .message
            .contains("OneDrive size_and_mtime not implemented"));
    }
    ...
    async fn test_onedrive_provider_save() {
        ...
        assert!(result
            .unwrap_err()
            .message
            .contains("OneDrive save not implemented"));
    }
